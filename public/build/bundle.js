...
var app = (function () {
    ...
    var Cookies = /*#__PURE__*/Object.freeze(/*#__PURE__*/_mergeNamespaces({
        __proto__: null,
        encode: encode_1,
        parse: parse_1,
        getAll: getAll_1,
    ...
    /* packages/wcmoon-dialog/Table.svelte generated by Svelte v3.46.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t = text("this is test component dialoaaaag");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Cookies, TokenKey, cookies, onMount });
    	return [];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1tjdw6m");
    			add_location(h1, file, 5, 1, 114);
    			attr_dev(main, "class", "svelte-1tjdw6m");
    			add_location(main, file, 4, 0, 106);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
